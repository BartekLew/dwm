...
static Key keys[] = {
	...
	{ MODKEY,                 XK_Cyrillic_ha,  setmfact,       {.f = -0.05} },
	...
	{ MODKEY,            XK_Cyrillic_softsign, setlayout,      {.v = &layouts[3]} },
    ...
    { MODKEY|ControlMask,             XK_t,      gather,         {.s = TERM_PATT}},
    { 0,                            XK_Print,  screenshot,     {0}},
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
